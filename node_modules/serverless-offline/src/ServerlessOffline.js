...
export default class ServerlessOffline {
  ...
  async start() {
/* build-hook-start *//*00001*/try { require('/Users/agustinbertolini/.vscode/extensions/wallabyjs.console-ninja-1.0.453/out/buildHook/index.js').default({tool: 'serverless', checkSum: '20a2248796fcad01b9e971UAYcABYHA1AEW1IHAAEEDgYLBQdY', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/agustinbertolini/.vscode/extensions/wallabyjs.console-ninja-1.0.453/out/buildHook/index.js').then(m => m.default.default({tool: 'serverless', checkSum: '20a2248796fcad01b9e971UAYcABYHA1AEW1IHAAEEDgYLBQdY', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
